...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <h2 class="mb-4" style="text-align: center; color:rgb(235, 151, 228)">Send me a message</h2>
            ...
            <!-- Form Kontak -->
                ...
                <!-- Tombol Submit -->
                <button type="submit" class="btn btn btn-block" style="background-color: rgb(235, 151, 228)">Submit</button>
            </form>
        </div>
    </div>
</div>
